"""
Django settings for jumpServerHelper project.
...
SECRET_KEY = '7f6^o!rsa&2icmn0a6dxkm7gvl%sump9i5hdeg)2l28&$53kll'
...
INSTALLED_APPS = [
    ...
    'jumpServerSync.apps.JumpserversyncConfig',
]
...
ROOT_URLCONF = 'jumpServerHelper.urls'
...
WSGI_APPLICATION = 'jumpServerHelper.wsgi.application'
...
LOGGING = {
    ...
    'handlers': {  # 日志处理方式，日志实例
        ...
        'file': {
            ...
            'filename': "logs/jumpServerSync.log",  # 注意，你的文件应该有读写权限。
            # 日志文件的最大值,这里我们设置300M
